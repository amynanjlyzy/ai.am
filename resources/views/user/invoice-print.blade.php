    ...
    <div id="printTable">
        ...
        <div class="mt-36px">
            ...
            <div class="address-side">
                ...
                <p class="bill-date">{{ __('Next Billing Date') }}: {{ timezoneFormatDate($subscription->next_billing_date) }}</p>
            </div>
            <div class="clear-both"></div>
        </div>
    </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-left td width-280">
                        <p> {{ ucfirst($subscription->billing_cycle) }} </p>
                    </td>
                    <td class="td text-left">
                        <p>{{ $subscription->renewable ? __('Yes') : __('No') }}</p>
                    </td>
                    <td class="td text-right">
                        <p>{{ formatCurrencyAmount($subscription->amount_billed) }}</p>
                    </td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <td></td>
                    <td></td>
                    <td class="footer-text color-89">{{ __('Sub Total') }}</td>
                    <td></td>
                    <td class="footer-text color-89 text-right">{{ formatCurrencyAmount($subscription->amount_billed) }}</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td class="border-bottom footer-text color-89"> {{ __('Other discount') }}</td>
                    <td class="border-bottom"></td>
                    <td class="border-bottom footer-text color-89 text-right">0.00</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
