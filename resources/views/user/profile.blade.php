                    ...
                    <div>
                        ...
                        <form class="mainForm" enctype='multipart/form-data' name="mainForm">
                            ...
                            <div class="mt-6 md:w-[426px]">
                                ...
                                <input class="border-color-DF dark:border-[#474746] dark:bg-[#333332] dark:text-white  px-4 py-3 mt-1.5 leading-6  font-normal text-base text-color-14 opacity-90 form-control border-color-89 dark:!border-color-47 rounded-xl m-0 focus:text-color-14 focus:bg-white focus:!border-color-DF focus:dark:!border-color-47 focus:outline-none md:w-[418px] w-full email-placeholder-text-color" type="email" id="update_email" placeholder="{{ $user->email }}" disabled>
                            </div>
                            <div class="mt-6 md:w-[426px]">
                                    ...
                                    <div class="password-modal-container">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative password-container">
                                                ...
                                                <a href="javascript: void(0)">
                                                    <svg class="absolute right-[14px] top-[15px]" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g>
                            ...
                            <div class="relative md:mt-40 xl:mt-20 xxs:mx-auto mx-4 md:px-6 px-3 py-5 w-max rounded-xl bg-white dark:bg-[#3A3A39] modal-h modal-box-shadow transition-all ease-in-out"
                                ...
                                <form name="checkEmailForm" id="checkEmailForm">
                                    ...
                                    <div class="existing-mail-container relative">
                                        ...
                                        <input class="border-color-DF dark:border-[#474746] dark:bg-[#333332] dark:text-white  px-4 py-3 mt-1.5 leading-6  font-normal text-base text-gray-10 form-control border-color-89 dark:!border-color-47 rounded-xl m-0 focus:text-color-14 focus:bg-white focus:!border-color-DF focus:dark:!border-color-47 focus:outline-none md:w-[418px] w-full email-placeholder-text-color" type="email" value="{{ $user->email }}" id="email" name="email" disabled>
