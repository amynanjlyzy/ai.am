<header class="navbar pcoded-header navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav me-auto d-flex flex-row flex-wrap float-left nav-menu ms-2">
            <li>
                <a href="javascript:" class="full-screen text-decoration-none ps-2" onclick="javascript:toggleFullScreen()"><i class="feather icon-maximize"></i></a>
            </li>
            <li class="nav-menu-home nav-parent">
                <a class="d-flex align-items-center hover_line text-decoration-none" href="{{ route('frontend.index') }}" target="_blank">
                    <span>
            ...
            <li class="ms-3 nav-parent">
                <a class="d-flex hover_line align-items-center text-decoration-none" href="{{ route('user.dashboard') }}" target="_blank">
                    <span>
        ...
        <ul class="navbar-nav ms-lg-auto ms-2 nav-icon me-5 me-lg-2">
            @php
