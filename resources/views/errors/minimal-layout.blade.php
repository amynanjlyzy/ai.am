...
<body>
    <div class="relative h-screen log-bg flex flex-col items-center pb-11 login-bg overflow-auto font-Figtree">
        <img class="mt-11" src="{{ asset('Modules/OpenAI/Resources/assets/image/arifism-light.png') }}">
        <div class="mt-14 relative flex flex-col items-center">
            ...
            <p class="lg:mt-[118px] mt-20 text-center text-color-14 lg:text-lg text-base font-normal font-Figtree px-5">@yield('message')</p>
            <a href="{{ route('frontend.index') }}" class="flex justify-center items-center mt-8">
                <span class="underline text-lg font-Figtree text-color-14 font-semibold">{{ __('Go to Homepage')}}</span> 
