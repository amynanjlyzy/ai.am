        ...
        <div class="relative bg-white dark:bg-[#3A3A39] rounded-3xl w-[350px] xs:w-[388px] sm:w-[506px] h-max px-4 sm:px-10 py-8 z-[2] mt-11">
            ...
            <form action="{{ route('login.post') }}" method="post" class="loginForm button-need-disable">
                ...
                <label class="block mt-5">
                    ...
                    <input type="email" class="form-control border border-color-89 dark:border-[#474746] rounded-xl h-12 w-full mt-1.5 px-2 text-color-14 dark:text-white dark:bg-[#333332] text-14 font-medium" value="{{ old('email') }}" name="email" placeholder="{{ __('Email Address') }}" required oninvalid="this.setCustomValidity('{{ $msg }}')" />
                </label>
                <div class="block mt-6">
                    ...
                    <div class="relative password-container">
                        <input type="password" class="form-control border border-color-89 dark:border-[#474746] rounded-xl h-12 w-full mt-1.5 px-2 text-color-14 dark:text-white dark:bg-[#333332] text-14 font-medium password-field" name="password" placeholder="{{ __('Password') }}" required oninvalid="this.setCustomValidity('{{ $msg }}')"/>
                        <a href="javascript: void(0)">
                            <svg class="absolute right-[14px] top-5" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g>
            ...
            @endif
            <img class="absolute bottom-[132px] left-[-117px] z-[-11] hidden md:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/robotlog.png') }}" alt="robotlog">
        </div>
    </div>
@endsection
