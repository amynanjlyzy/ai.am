    ...
    <div class="relative bg-white dark:bg-[#3A3A39] rounded-3xl w-[350px] xs:w-[388px] sm:w-[506px] h-max px-5 sm:px-10 py-8 z-[2] mt-11">
        ...
        <form action="{{ route('users.registration') }}" method="post" id="password-validate-submit" autocomplete="off">
            ...
            <label class="block mt-6">
                ...
                <input type="text" class="form-control border border-color-89 dark:border-[#474746] rounded-xl h-12 w-full mt-1.5 px-2 text-color-14 dark:text-white dark:bg-[#333332] text-14 font-medium" value="{{ old('email') }}" name="email" placeholder="{{ __('Email Address')}}" required oninvalid="this.setCustomValidity('{{ $msg }}')" readonly onfocus="this.removeAttribute('readonly');"/>
            </label>
            <label class="block mt-6">
