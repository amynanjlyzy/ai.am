<div id="digital_art" class="relative 6xl:mt-[120px] mt-[72px]">
    ...
    <div class="flex 2xl:flex-row flex-col z-40 relative justify-between gap-11 2xl:gap-4">
        <div class="6xl:pt-[122px] 9xl:pl-[310px] 8xl:pl-40 7xl:pl-32 lg:pl-16 md:pl-10 pl-5 pt-12 relative">
            <div class="relative">
                <p class="uppercase heading-2 absolute tracking-[0.2em] font-Figtree text-16 font-bold">{{ __('image generator')}}
                </p>
            </div>
            <p class="text-white mt-[30px] 6xl:text-48 text-36 font-bold font-RedHat 7xl:w-[520px] md:pr-0 pr-5 2xl:w-[375px]">{{ __('Generate Digital Arts Like Never Before')}}
            </p>
            <p class="text-white 6xl:text-18 text-16 font-Figtree font-normal mt-3 lg:pr-[117px] pr-9">{{ __("Create AI art or images from text that turns your imagination into unique images in seconds. Finally, you'll have the perfect picture to match your message.") }}</p>
            <div class="6xl:mt-9 mt-8 relative pl-5">
            ...
            <div class="flex flex-wrap gap-4 my-12 relative mr-5">
                <a class="font-Figtree text-white items-center text-center font-semibold text-18 bg-color-E6 py-3.5 px-8 rounded-lg"
                    href="{{ config('openai.demo_url') }}" target="_blank">{{ __('Watch Demo')}}</a>
                <a class="font-Figtree text-white dark:text-color-14 flex justify-center items-center font-semibold text-18 gap-2.5 learn-more-button h-[54px] rounded-lg"
                    href="{{ route('site.page', [ 'slug' => 'about-us' ]) }}"> <span class="pl-[27px]">{{ __('Learn More')}}</span> <svg class="mr-[27px]" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex 2xl:flex-row flex-col gap-9">
            ...
            <div class="main-div 2xl:pr-9 pr-0 pb-12 lg:pb-9 2xl:pb-0">
                <div class="slider m-auto overflow-hidden relative">
                    <div class="slider-wrap flex gap-6 2xl:flex-col flex-row 2xl:w-full 2xl:h-[778px]">
