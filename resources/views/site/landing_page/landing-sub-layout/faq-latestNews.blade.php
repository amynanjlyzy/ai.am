...
<div class="{{count($blogs) != 0 ? 'justify-between 9xl:pl-[310px] 8xl:pl-40 7xl:pl-32 2xl:pl-16 gap-5' : 'justify-center text-center items-center 9xl:px-[310px] 8xl:px-40 lg:px-16 md:px-10 px-5'}} 6xl:mt-40 mt-[60px] w-full flex xl:flex-row flex-col xl:relative">
    <div class="mt-3 mb-8 xl:mb-0 2xl:pl-0 relative {{count($blogs) != 0 ? '2xl:w-[34%] xl:w-[44%] lg:w-1/2 w-full lg:pl-16 md:pl-10 pl-5' : '5xl:w-[36%] md:w-1/2 w-full'}}">
    ...
    @if (count($blogs) != 0)
        <div class="latest-news 2xl:w-[66%] w-full overflow-hidden pl-0 6xl:rounded-[30px] !rounded-6">
            <div class="swiper slider2 6xl:rounded-[30px] !rounded-6">
                <img class="absolute top-0 lg:right-[50px] right-[316px] z-50 dark:hidden hidden lg:block"
                    src="{{ asset('Modules/OpenAI/Resources/assets/image/white-overlay.png') }}" alt="">
                <img class="absolute top-0 lg:right-[50px] right-[316px] z-50 hidden dark:hidden lg:dark:block"
            ...
            <div class="swiper-button-next bg-white dark:bg-color-14 text-color-14 dark:text-white rounded-full">
                <svg class="w-full h-full m-[9px] bg-white dark:bg-color-14 text-color-14 dark:text-white"
