    ...
    <div class="dark:bg-color-14">
        ...
        <div class="md:mt-[122px] mt-[97px] dark:bg-color-14">
            ...
            <div class="text-center">
                <div
                    ...
                    <div class="flex lg:flex-row flex-col items-center justify-center gap-3">
                        <img src="{{ asset('Modules/OpenAI/Resources/assets/image/pen-tool1.svg') }}"
                            alt="{{ __('Image') }}">
                    ...
                    <div class="flex lg:flex-row flex-col items-center justify-center gap-3">
                        <img src="{{ asset('Modules/OpenAI/Resources/assets/image/flash-1.svg') }}"
                            alt="{{ __('Image') }}">
                        <span class="text-color-14 dark:text-white text-18 font-Figtree font-medium">
                    ...
                    <div class="flex lg:flex-row flex-col items-center justify-center gap-3">
                        <img src="{{ asset('Modules/OpenAI/Resources/assets/image/rocket1.svg') }}"
                            alt="{{ __('Image') }}">
                        <span class="text-color-14 dark:text-white text-18 font-Figtree font-medium">
                ...
                <a href="{{ route('users.registration') }}"
                    class="inline-flex h-[58px] gap-2.5 text-center items-center mx-auto justify-center mt-9 rounded-lg free-button"><span
                        class="text-18 pl-[27px] font-semibold text-color-14 dark:text-white font-Figtree rounded-lg">
                        {{ __('Get Started for Free') }}</span> <svg class="mr-[27px]" xmlns="http://www.w3.org/2000/svg" width="14"
            ...
            <div class="relative 2xl:pt-[182px] pt-[52px] bg-white dark:bg-color-14">
                <img class="absolute -top-[28rem] w-full hidden sm:block"
                    src="{{ asset('Modules/OpenAI/Resources/assets/image/bg-three.png') }}" alt="">
                <span class="w-full">
                    <img class="absolute w-full block sm:hidden"
            ...
            <div>
                <div class="relative sm:top-[111px] top-[72px] rounded-[40px] flex justify-center">
                    <img class="absolute h-full 9xl:px-[310px] 8xl:px-40 lg:px-16 md:px-10 px-5 rounded-[54px] md:rounded-0 w-full"
                    ...
                    <div
                        ...
                        <div class="lg:pl-[72px] px-[26px] xl:mb-[86px] md:mb-10 mb-0">
                        ...
                        <img class="lg:-mt-[52px] lg:mb-10 -mb-[33px] lg:ml-0 sm:ml-7 xs:ml-[65px] m-auto lg:w-[479px] lg:h-[452px] md:w-[395px] md:h-[360px] w-[295px] h-[278px]"
