        ...
        <div class="relative background-one">
            ...
            <div class="9xl:px-[310px] 8xl:px-40 lg:px-16 relative">
                ...
                <div class="flex flex-wrap justify-center items-center md:gap-10 gap-[26px] mt-[60px] md:px-10 px-0">
                    <img class="w-[200px] h-[60px] dark:hidden" src="{{ asset('Modules/OpenAI/Resources/assets/image/lense-eye.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] hidden dark:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/lense-eye-dark.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] dark:hidden" src="{{ asset('Modules/OpenAI/Resources/assets/image/conn3ctr.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] hidden dark:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/conn3ctr-dark.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] dark:hidden" src="{{ asset('Modules/OpenAI/Resources/assets/image/fusion.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] hidden dark:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/fusion-dark.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] dark:hidden" src="{{ asset('Modules/OpenAI/Resources/assets/image/one-square.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] hidden dark:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/one-square-dark.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] dark:hidden" src="{{ asset('Modules/OpenAI/Resources/assets/image/g-diamond.svg') }}" alt="{{ __('Image') }}">
                    <img class="w-[200px] h-[60px] hidden dark:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/g-diamond-dark.svg') }}" alt="{{ __('Image') }}">
                </div>
            </div>
        </div>
        @if (count($packages) != 0)
                                                            ...
                                                            <tr>
                                                                ...
                                                                @foreach($packages as $key => $package)
                                                                    <th class="w-1/4 px-7">
                                                                        ...
                                                                        <p class="font-Figtree text-sm font-normal text-color-14 dark:text-white mt-1.5">{{ $package['discount_price'] > 0 ? formatNumber($package['discount_price']) : formatNumber($package['sale_price']) }}</p>
                                                                    </th>
                                                                @endforeach
                                                            </tr>
                                                        </thead>
                                        ...
                                        @foreach ($features as $feature)
                                            ...
                                            <tr>
                                                <td class="text-left text-color-14 dark:text-white text-base font-medium w-[300px] font-Figtree  pt-10">
                                                    <p class="w-[300px] pl-8">{{ $feature['title'] }}</p>
                                                </td>
                                                @foreach($packages as $key => $package)
        ...
        <div class="9xl:px-[310px] 8xl:px-40 lg:px-16 md:px-10 px-5 lg:mt-[120px] py-[52px] lg:pb-16 dark:bg-color-14 text-center">
            <div class="rounded-[40px] get-started-for-free">
                ...
                <div class="relative pb-10 md:pb-0">
                    <a href="{{route('users.registration')}}" class="bg-white h-[54px] inline-flex gap-2.5 text-center items-center mx-auto justify-center mt-8 md:mb-[58px] rounded-lg"><span class="text-18 font-semibold pl-[27px] text-color-14 font-Figtree rounded-lg">
                        {{ __('Get Started for Free')}}</span>
                        <svg class="mr-[27px]" xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
                    ...
                    <img class="absolute top-[-30px] left-[88px] hidden xl:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/google.png') }}">
                    <img class="absolute top-0 right-[88px] hidden xl:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/ink.png') }}">
                </div>
                <div class="relative flex justify-center w-max mx-auto">
                    ...
                    <img class="hidden lg:block absolute -top-[25px] left-40" src="{{ asset('Modules/OpenAI/Resources/assets/image/mike.png') }}">
                    <img class="hidden lg:block absolute bottom-10 z-[50] -left-5" src="{{ asset('Modules/OpenAI/Resources/assets/image/youtube.png') }}">
                    <img class="hidden lg:block absolute bottom-5 xl:bottom-[53px] z-[50] -right-[154px]" src="{{ asset('Modules/OpenAI/Resources/assets/image/img-robo-target.png') }}">
                </div>
            </div>
        </div>
    </div>
@endsection
@section('js')
<script src="{{ asset('public/assets/js/site/pricing.min.js') }}"></script>
@endsection
