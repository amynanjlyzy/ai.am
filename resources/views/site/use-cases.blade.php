        ...
        <div class="9xl:px-[310px] 8xl:px-40 lg:px-20 md:px-10 px-5 pb-16">
            ...
            <div class="rounded-[40px] mt-[31px] relative get-started-for-free text-center">
                ...
                <div class="relative pb-10 md:pb-0">
                    <a href="{{route('users.registration')}}" class="bg-white h-[54px] inline-flex gap-2.5 text-center items-center mx-auto justify-center mt-8 md:mb-[58px] rounded-lg"><span class="text-18 pl-[27px] font-semibold text-color-14 font-Figtree rounded-lg ">
                    ...
                    <img class="absolute top-[-30px] left-[88px] hidden xl:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/google.png') }}" alt="{{ __('Image') }}">
                    <img class="absolute top-0 right-[88px] hidden xl:block" src="{{ asset('Modules/OpenAI/Resources/assets/image/ink.png') }}" alt="{{ __('Image') }}">
                </div>
                <div class="relative flex justify-center w-max mx-auto">
                    ...
                    <img class="hidden xl:block absolute bottom-5 xl:bottom-[53px] z-[50] -right-[154px]" src="{{ asset('Modules/OpenAI/Resources/assets/image/img-robo-target.png') }}">
                </div>
            </div>
        </div>
    </div>
